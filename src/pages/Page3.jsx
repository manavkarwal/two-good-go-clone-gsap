...
const Page3 = () => {
    ...
    return (
        <div onMouseMove={mouseMoved} className='relative '>
         

                <div ref={cursorRef} className="fixed  -z-10 opacity-0 scale-0 h-38 w-38 bg-amber-100 rounded-full"></div>

                <div className="flex flex-wrap px-40 py-10 mt-10 gap-20 items-center justify-between">
                    <div onMouseEnter={mouseEnter} onMouseLeave={MouseLeave} className="h-130 w-110 flex items-center justify-center  overflow-hidden">
                        <img
